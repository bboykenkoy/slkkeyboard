...
UIGestureRecognizerDelegate, UIAlertViewDelegate , UICollectionViewDelegate, UICollectionViewDataSource, EmojiCustomCollectionViewCellDelegate>



@property (nonatomic) NSMutableArray * arrEmoji;
...
/** if show emoji then not change frame view **/
@property (nonatomic, assign) BOOL isShowEmoji;
...
@property (nonatomic, readonly) UIButton *rightButtonEmoji;
...
#pragma mark phuonghv add func show emoji
...
- (void)didPressRightButtonEmoji:(id _Nullable)sender NS_REQUIRES_SUPER;
